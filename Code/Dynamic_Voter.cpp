...
double Dynamic_Voter::simulate(float alpha, float beta, int mode, float gamma, int dt, double max_steps, string process, string comp, string ddist, string edgelist, string opinion) {
	long int e1,e2;
	...
	ofstream pFile_process, pFile_comp, pFile_degree, pFile_edgelist, pFile_opinion;
