...
// -n number_of_nodes -m number_of_edges -u number_of_opinions initial_densities -a alpha -t dt -T max_steps -o output_filename
...
//	Initialize the parameters
	...
	steps = dv->simulate(alpha,dt,max_steps,process);
